...
public class WebPageController {
    ...
    private ResponseEntity<Map<String, Object>> handleContactSubmission(
        ...
        log.info(
                "Contact received: inquiryType={}, name={}, email={}, plan={}, date={}, contactMethod={}, requestType={}, message={}",
                contactForm.getInquiryType(),
                contactForm.getName(),
                contactForm.getEmail(),
                contactForm.getPlan(),
                contactForm.getDate(),
                contactForm.getContactMethod(),
                contactForm.getRequestType(),
